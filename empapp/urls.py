...
from .func import UpdateEmployeeProfile, ChangePassword, ChangeEmployeeRoleManager, UpdateUserProfile
...
urlpatterns = [
    ...
    path('api/profiles/update/<str:username>/', UpdateUserProfile.as_view(), name='update_user_profile'),
